...
func registerSDKWords(r *eng.Registry, client *sdk.KiprioHttpApisSDK) {
...
func runOp(client *sdk.KiprioHttpApisSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
