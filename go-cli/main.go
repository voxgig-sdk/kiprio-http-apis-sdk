// Command KiprioHttpApis-cli is a CLI + REPL for the KiprioHttpApis SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      KIPRIO_HTTP_APIS_APIKEY (api key), KIPRIO_HTTP_APIS_BASE (base url override)")
