...
func registerTools(server *mcp.Server, client *sdk.KiprioHttpApisSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "kiprio-http-apis_list",
		Description: "List records from KiprioHttpApis. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "kiprio-http-apis_load",
		Description: "Load a single record from KiprioHttpApis. " +
...
func runOp(client *sdk.KiprioHttpApisSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.KiprioHttpApisSDK, name string) (sdk.KiprioHttpApisEntity, error) {
