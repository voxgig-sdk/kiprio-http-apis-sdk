...
// KiprioHttpApis SDK cache feature
...
class KiprioHttpApisCacheFeature extends KiprioHttpApisBaseFeature
{
    ...
    private function _through(KiprioHttpApisContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
