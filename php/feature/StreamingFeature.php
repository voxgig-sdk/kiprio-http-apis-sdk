...
// KiprioHttpApis SDK streaming feature
...
class KiprioHttpApisStreamingFeature extends KiprioHttpApisBaseFeature
{
    ...
    private function _iterate(KiprioHttpApisResult $result): \Generator
    {
    ...
    private function _streamable(KiprioHttpApisContext $ctx): bool
    {
