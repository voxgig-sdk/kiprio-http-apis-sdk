...
// KiprioHttpApis SDK debug feature
...
class KiprioHttpApisDebugFeature extends KiprioHttpApisBaseFeature
{
    ...
    private function _finish(KiprioHttpApisContext $ctx, bool $ok): void
    {
