...
// KiprioHttpApis SDK rbac feature
...
class KiprioHttpApisRbacFeature extends KiprioHttpApisBaseFeature
{
    ...
    private function _required(KiprioHttpApisContext $ctx): ?string
    {
    ...
    private function _reject(KiprioHttpApisContext $ctx, string $required): void
    {
    ...
    private function _track(KiprioHttpApisContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
