...
// KiprioHttpApis SDK audit feature
...
class KiprioHttpApisAuditFeature extends KiprioHttpApisBaseFeature
{
    ...
    private function _emit(KiprioHttpApisContext $ctx, string $outcome): void
    {
