...
// KiprioHttpApis SDK telemetry feature
...
class KiprioHttpApisTelemetryFeature extends KiprioHttpApisBaseFeature
{
    ...
    private function _close(KiprioHttpApisContext $ctx, bool $ok): void
    {
