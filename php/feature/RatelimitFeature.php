...
// KiprioHttpApis SDK ratelimit feature
...
class KiprioHttpApisRatelimitFeature extends KiprioHttpApisBaseFeature
{
    ...
    private function _acquire(KiprioHttpApisContext $ctx): void
    {
    ...
    private function _track(KiprioHttpApisContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
