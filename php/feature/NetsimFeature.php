...
// KiprioHttpApis SDK netsim feature
...
class KiprioHttpApisNetsimFeature extends KiprioHttpApisBaseFeature
{
    ...
    private function _simulate(KiprioHttpApisContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(KiprioHttpApisContext $ctx, array $applied): void
    {
        $client = $this->client;
