...
// KiprioHttpApis SDK timeout feature
...
class KiprioHttpApisTimeoutFeature extends KiprioHttpApisBaseFeature
{
    ...
    private function _with_timeout(KiprioHttpApisContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(KiprioHttpApisContext $_ctx, float $ms): void
    {
        $client = $this->client;
