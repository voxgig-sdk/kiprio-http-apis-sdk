...
// KiprioHttpApis SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (KiprioHttpApisSDK::test)
...
{
    private const SDK_CLASS = 'KiprioHttpApisSDK';
    ...
    private const SDK_BASE = 'kipriohttpapis_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../kipriohttpapis_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
