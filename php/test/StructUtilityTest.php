...
// KiprioHttpApis SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = KiprioHttpApisOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(KiprioHttpApisOmni::structfix($now, Struct::undef()))
                        !== json_encode(KiprioHttpApisOmni::structfix($val, Struct::undef()))) {
