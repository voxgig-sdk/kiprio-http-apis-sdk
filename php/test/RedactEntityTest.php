...
class RedactEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set KIPRIOHTTPAPIS_TEST_REDACT_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function redact_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("KIPRIOHTTPAPIS_TEST_REDACT_ENTID");
