...
// KiprioHttpApis SDK utility: graphql
//
...
class KiprioHttpApisGraphql
{
    ...
    // equivalent.
    public static function body(KiprioHttpApisContext $ctx): mixed
    {
    ...
    public static function errors(KiprioHttpApisContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
