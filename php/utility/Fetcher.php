...
// KiprioHttpApis SDK utility: fetcher

class KiprioHttpApisFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; KiprioHttpApisSDK/1.0)';
    ...
    public static function call(KiprioHttpApisContext $ctx, string $fullurl, array $fetchdef): array
    {
