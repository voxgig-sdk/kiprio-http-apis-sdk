...
// KiprioHttpApis SDK clienttrack feature
...
class KiprioHttpApisClienttrackFeature extends KiprioHttpApisBaseFeature
{
    ...
    public function PostConstruct(KiprioHttpApisContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'KiprioHttpApis-SDK';
