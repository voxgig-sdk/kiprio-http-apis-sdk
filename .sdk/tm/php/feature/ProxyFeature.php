...
// KiprioHttpApis SDK proxy feature
...
class KiprioHttpApisProxyFeature extends KiprioHttpApisBaseFeature
{
    ...
    public function init(KiprioHttpApisContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (KiprioHttpApisContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
