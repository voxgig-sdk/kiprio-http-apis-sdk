...
// KiprioHttpApis SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class KiprioHttpApisTransformResponse
{
    public static function call(KiprioHttpApisContext $ctx): mixed
    {
        ...
        $transform = KiprioHttpApisHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
