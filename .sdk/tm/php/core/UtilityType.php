...
// KiprioHttpApis SDK utility type

class KiprioHttpApisUtility
{
    ...
    public static function copy(KiprioHttpApisUtility $src): KiprioHttpApisUtility
    {
        $u = new KiprioHttpApisUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
