...
class KiprioHttpApisTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = KiprioHttpApisTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = KiprioHttpApisTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = KiprioHttpApisTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
