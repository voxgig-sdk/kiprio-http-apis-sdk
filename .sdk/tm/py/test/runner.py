...
class KiprioHttpApisTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = KiprioHttpApisTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = KiprioHttpApisTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = KiprioHttpApisTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
