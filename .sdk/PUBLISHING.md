...
|---|---|---|
| `ts/` | @voxgig-sdk/kiprio-http-apis-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/kiprio-http-apis-sdk \
      --repository voxgig-sdk/kiprio-http-apis-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/kiprio-http-apis-sdk` shows it, and
`npm trust revoke @voxgig-sdk/kiprio-http-apis-sdk --id=<id>` removes it.
