...
function runner.env_override(m)
  local live = runner.getenv("KIPRIOHTTPAPIS_TEST_LIVE")
  local override = runner.getenv("KIPRIOHTTPAPIS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("KIPRIOHTTPAPIS_TEST_EXPLAIN")
