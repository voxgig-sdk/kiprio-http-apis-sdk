...
require("kiprio-http-apis_types")
...
-- by passing it.
function KiprioHttpApisSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function KiprioHttpApisSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "KiprioHttpApisSDK: graphql: " .. msg
    res.graphql = errors
  end
