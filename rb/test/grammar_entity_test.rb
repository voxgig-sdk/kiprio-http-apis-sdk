...
class GrammarEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set KIPRIOHTTPAPIS_TEST_GRAMMAR_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def grammar_basic_setup(extra)
  ...
  entid_env_raw = ENV["KIPRIOHTTPAPIS_TEST_GRAMMAR_ENTID"]
