...
class RedactEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set KIPRIO_HTTP_APIS_TEST_REDACT_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def redact_basic_setup(extra)
  ...
  entid_env_raw = ENV["KIPRIO_HTTP_APIS_TEST_REDACT_ENTID"]
