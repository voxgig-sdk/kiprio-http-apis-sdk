...
#      offline in seeded test mode (KiprioHttpApisSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "KiprioHttpApis_sdk.rb")
  SDK_CLASS = "KiprioHttpApisSDK"
