# KiprioHttpApis Python SDK



The Python SDK for the KiprioHttpApis API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/kiprio-http-apis-sdk/releases)) or
...
client = KiprioHttpApisSDK({
    "apikey": os.environ.get("KIPRIO_HTTP_APIS_APIKEY"),
})
```
...
```
py/
├── kipriohttpapis_sdk.py         -- Main SDK module
...
The main module (`kipriohttpapis_sdk`) exports the SDK class.
