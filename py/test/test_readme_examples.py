# KiprioHttpApis SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions KiprioHttpApisSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both KiprioHttpApisSDK(...) and KiprioHttpApisSDK.test(...) become
#      KiprioHttpApisSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "kipriohttpapis_sdk"
_SDK_CLASS = "KiprioHttpApisSDK"
