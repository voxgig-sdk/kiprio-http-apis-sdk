...
class KiprioHttpApisTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = KiprioHttpApisTestRunner.getenv("KIPRIOHTTPAPIS_TEST_LIVE")
        override = KiprioHttpApisTestRunner.getenv("KIPRIOHTTPAPIS_TEST_OVERRIDE")
        ...
        explain = KiprioHttpApisTestRunner.getenv("KIPRIOHTTPAPIS_TEST_EXPLAIN")
