...
from kipriohttpapis_sdk.core.spec import KiprioHttpApisSpec
from kipriohttpapis_sdk.core import helpers

# Load utility registration (populates Utility._registrar)
from kipriohttpapis_sdk.utility import register

# Load features
from kipriohttpapis_sdk.feature.base_feature import KiprioHttpApisBaseFeature
from kipriohttpapis_sdk.features import _has_feature, _make_feature


class KiprioHttpApisSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = KiprioHttpApisUtility()
        self._utility = utility

        from kipriohttpapis_sdk.config import shared_config
    ...
    def get_utility(self):
        return KiprioHttpApisUtility.copy(self._utility)
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "KiprioHttpApisSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("KiprioHttpApisSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def DnsResult(self, data=None) -> "DnsResultEntity":
        ...
        from kipriohttpapis_sdk.entity.dns_result_entity import DnsResultEntity
    ...
    def Domain(self, data=None) -> "DomainEntity":
        ...
        from kipriohttpapis_sdk.entity.domain_entity import DomainEntity
    ...
    def EmailValidate(self, data=None) -> "EmailValidateEntity":
        ...
        from kipriohttpapis_sdk.entity.email_validate_entity import EmailValidateEntity
    ...
    def Generate(self, data=None) -> "GenerateEntity":
        ...
        from kipriohttpapis_sdk.entity.generate_entity import GenerateEntity
    ...
    def Utility(self, data=None) -> "UtilityEntity":
        ...
        from kipriohttpapis_sdk.entity.utility_entity import UtilityEntity
        return UtilityEntity(self, data)


    def Whoi(self, data=None) -> "WhoiEntity":
        """Entity factory: client.Whoi().list() / client.Whoi().load({"id": ...})."""
        from kipriohttpapis_sdk.entity.whoi_entity import WhoiEntity
        return WhoiEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "KiprioHttpApisSDK":
        if sdkopts is None:
            sdkopts = {}
