...
from kipriohttpapis_sdk.core.control import KiprioHttpApisControl
...
from kipriohttpapis_sdk.core.helpers import get_ctx_prop, to_map
...
class KiprioHttpApisContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = KiprioHttpApisControl()
        ...
        if isinstance(sp, KiprioHttpApisSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, KiprioHttpApisResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, KiprioHttpApisResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return KiprioHttpApisOperation({})
    ...
    def make_error(self, code, msg):
        return KiprioHttpApisError(code, msg, self)
