...
(0, node_test_1.describe)('EmailValidateDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.KiprioHttpApisSDK({
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'KIPRIO_HTTP_APIS_TEST_EMAIL_VALIDATE_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.KiprioHttpApisSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {
            apikey: env.KIPRIO_HTTP_APIS_APIKEY,
        }));
        let idmap = env['KIPRIO_HTTP_APIS_TEST_EMAIL_VALIDATE_ENTID'];
    ...
    const client = new __1.KiprioHttpApisSDK({
        base: 'http://localhost:8080',
