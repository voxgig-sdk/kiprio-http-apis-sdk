...
(0, node_test_1.describe)('EmailValidateEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set KIPRIO_HTTP_APIS_TEST_EMAIL_VALIDATE_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['KIPRIO_HTTP_APIS_TEST_EMAIL_VALIDATE_ENTID'];
    ...
    idmap = env['KIPRIO_HTTP_APIS_TEST_EMAIL_VALIDATE_ENTID'];
