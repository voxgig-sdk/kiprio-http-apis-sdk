...
(0, node_test_1.describe)('DomainEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set KIPRIO_HTTP_APIS_TEST_DOMAIN_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['KIPRIO_HTTP_APIS_TEST_DOMAIN_ENTID'];
    const idmapOverridden = null != idmapEnvVal && idmapEnvVal.trim().startsWith('{');
    const env = (0, utility_1.envOverride)({
        'KIPRIO_HTTP_APIS_TEST_DOMAIN_ENTID': idmap,
        'KIPRIO_HTTP_APIS_TEST_LIVE': 'FALSE',
        'KIPRIO_HTTP_APIS_TEST_EXPLAIN': 'FALSE',
        'KIPRIO_HTTP_APIS_APIKEY': '',
    });
    idmap = env['KIPRIO_HTTP_APIS_TEST_DOMAIN_ENTID'];
