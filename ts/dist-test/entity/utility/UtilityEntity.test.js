...
(0, node_test_1.describe)('UtilityEntity', async () => {
    ...
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('KIPRIO_HTTP_APIS_TEST_LIVE'));
    (0, node_test_1.test)('instance', async () => {
        const testsdk = __1.KiprioHttpApisSDK.test();
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set KIPRIO_HTTP_APIS_TEST_UTILITY_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    let client = __1.KiprioHttpApisSDK.test(options, extra);
    ...
    const idmapEnvVal = process.env['KIPRIO_HTTP_APIS_TEST_UTILITY_ENTID'];
    const idmapOverridden = null != idmapEnvVal && idmapEnvVal.trim().startsWith('{');
    const env = (0, utility_1.envOverride)({
        'KIPRIO_HTTP_APIS_TEST_UTILITY_ENTID': idmap,
        'KIPRIO_HTTP_APIS_TEST_LIVE': 'FALSE',
        'KIPRIO_HTTP_APIS_TEST_EXPLAIN': 'FALSE',
        'KIPRIO_HTTP_APIS_APIKEY': '',
    });
    idmap = env['KIPRIO_HTTP_APIS_TEST_UTILITY_ENTID'];
    const live = 'TRUE' === env.KIPRIO_HTTP_APIS_TEST_LIVE;
    if (live) {
        client = new __1.KiprioHttpApisSDK(merge([
