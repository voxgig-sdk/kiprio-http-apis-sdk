...
declare class KiprioHttpApisSDK {
    _mode: string;
    _options: any;
    _utility: Utility;
    _features: Feature[];
    ...
    static test(testoptsarg?: any, sdkoptsarg?: any): KiprioHttpApisSDK;
    tester(testopts?: any, sdkopts?: any): KiprioHttpApisSDK;
    toJSON(): {
        name: string;
    };
    toString(): string;
...
declare const SDK: typeof KiprioHttpApisSDK;
export { stdutil, config, BaseFeature, KiprioHttpApisEntityBase, KiprioHttpApisSDK, SDK, };
