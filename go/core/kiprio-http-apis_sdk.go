...
func (sdk *KiprioHttpApisSDK) OptionsMap() map[string]any {
...
func (sdk *KiprioHttpApisSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *KiprioHttpApisSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *KiprioHttpApisSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *KiprioHttpApisSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *KiprioHttpApisSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *KiprioHttpApisSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("KiprioHttpApisSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *KiprioHttpApisSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *KiprioHttpApisSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("KiprioHttpApisSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func (sdk *KiprioHttpApisSDK) DnsResult(data map[string]any) KiprioHttpApisEntity {
...
func (sdk *KiprioHttpApisSDK) Domain(data map[string]any) KiprioHttpApisEntity {
...
func (sdk *KiprioHttpApisSDK) EmailValidate(data map[string]any) KiprioHttpApisEntity {
...
func (sdk *KiprioHttpApisSDK) Generate(data map[string]any) KiprioHttpApisEntity {
...
func (sdk *KiprioHttpApisSDK) Grammar(data map[string]any) KiprioHttpApisEntity {
...
func (sdk *KiprioHttpApisSDK) Ipn(data map[string]any) KiprioHttpApisEntity {
...
func (sdk *KiprioHttpApisSDK) Redact(data map[string]any) KiprioHttpApisEntity {
...
func (sdk *KiprioHttpApisSDK) Ssl(data map[string]any) KiprioHttpApisEntity {
...
func (sdk *KiprioHttpApisSDK) Utility(data map[string]any) KiprioHttpApisEntity {
...
func (sdk *KiprioHttpApisSDK) Whoi(data map[string]any) KiprioHttpApisEntity {
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *KiprioHttpApisSDK {
	...
	sdk := NewKiprioHttpApisSDK(sdkopts)
	sdk.Mode = "test"
